...
public class TenantContractDocumentServiceImpl implements TenantContractDocumentService {
    ...
    private TenantContractResponse toContractResponse(TenantContract c) {
        ...
        return TenantContractResponse.builder()
                ...
                .roomConditionUrls(c.getRoomConditionPhotos() == null ? List.of()
                        : c.getRoomConditionPhotos().stream()
                        .map(com.sep490.slms2026.entity.ContractEvidencePhoto::getImageUrl)
                        .filter(u -> u != null && !u.isBlank())
                        .toList())
                .roomConditionPhotos(c.getRoomConditionPhotos() == null ? List.of()
                        : c.getRoomConditionPhotos().stream()
                        .map(p -> com.sep490.slms2026.dto.response.ContractEvidencePhotoResponse.builder()
                                .url(p.getImageUrl())
